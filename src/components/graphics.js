...
let defaultkey = Object.keys(data.Portfolio.GFX[0])[0];
...
class CgGraphics extends Component {
    constructor(props) {
        ...
        this.state = {
            active: Object.keys(data.Portfolio.GFX[0])[0]
        }
    ...
    componentWillMount() {
        if (!this.props.current) {
            this.props.activeitem(Object.keys(data.Portfolio.GFX[0])[0], data.Portfolio.GFX[0][defaultkey], data.Portfolio.GFX[0].Tech, data.Portfolio.GFX[0].Desc, data.Portfolio.GFX[0].Title);
        }
    }
