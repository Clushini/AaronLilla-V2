            ...
            <Scrollbars renderThumbVertical={props => < div {...props} className="thumb-vertical-green"/>} renderTrackVertical={props => < div {...props} className="track-vertical"/>} style={{ width: "100%", height: "calc(100% - 54px)" }}>
                ...
                <div className="summaryright">
                        ...
                        <div className="summaryrightinfowrap">
                            <div className="summaryrightbigtitle">Design</div>
                            {
                                data.About.Summary.Descat.map(item => {
                                    return <div className="summaryrightsub">{item}</div>
                                })
                            }
                    ...
                    <div className="summaryleft">
                        ...
                        I'm someone who always has ideas for some new "million dollar web app" (hasn't happened... yet) and always have some interesting project to keep me busy in addition to client's work. I really do love designing, developing, and thinking of new web apps and I also love the journey to a completed project. I'm always learning something new and I'm certainly always willing to learn.<br /><br />
