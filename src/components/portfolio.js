        ...
        return(
            <div className="paddingfix">
                <div className="portfoliowrap">
                    ...
                    <div className="pitem">
                    <Scrollbars renderThumbVertical={props => < div {...props} className="thumb-vertical"/>} renderTrackVertical={props => < div {...props} className="track-vertical"/>} style={{ width: "100%", height: "100%" }} autohide>
                        {
                            (this.state.activelink.split('.').pop() == "mp4") ? <video width="100%" height="auto" key={this.state.activelink} muted autoPlay loop><source src={this.state.activelink} type="video/mp4"/></video> : <img src={this.state.activelink} /> 
                        }
